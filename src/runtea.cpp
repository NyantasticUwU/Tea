...
{
    const std::size_t &&s_statementSize{statement.size()};
...
namespace tea
{
    ...
    void runTea(const std::vector<std::string> &teafile, const char *&filename,
        const std::string &currentNamespace, const teaString_t *const &pteaStrings,
    ...
    const std::string currentNamespace)
{
    ...
    tea::runTea(teafile, fn, currentNamespace);
}
